...
def iterate_student_solutions(evaluation_log_file=None, solutions_dir=None,
                              ...
                              for_jmbag=None, student_log_dir=None):
    student_reports = {}
    ...
    for subtask in test_suite:
        ...
        for test_instance in test_suite[subtask]:
            ...
            report = {
                ...
                'expected_output': '',
                'correct_fields': 0,
                'field_results': {field: False for field in
                                  test_instance['expected_output_fields']},
            ...
            if result_code == ERR_EXECUTE:
                ...
                if not report['test_passed']:
                    report['expected_output'] = test_instance[
...
def main():
    ...
    solutions_root_path = "solutions"
    test_suites_path = "test_suites_lab2"
    evaluation_log_file = "full.log"
    lab_files_dir = "lab2_files"
